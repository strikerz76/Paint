...
//	MOVE("Move", "(m) Move: use the mouse to move and resize canvas", "resources/move.png"), 
	EXTRACT("Extract", "(e) Extract: draw a rectangle to extract a section of the image into a new layer", "/select.png"), 
	...
	COLOR_PICKER("Color Picker", "(p) Color Picker: choose a color from the image. (Hold shift to assign the alternate color)", "/color_picker.png"),
	;
	private String name;
